...
/******/ 	var hotCurrentHash = "4b04138e583decf41b9d"; // eslint-disable-line no-unused-vars
...
var _bulma = __webpack_require__(27);
      ...
      return {
        text: function text() {
          ...
          return tags.reduce(function (tagsStr, tag) {
            ...
            return closed ? tagsStr + "<" + type + " " + attribute + "=\"true\" " + attrs + "/>" : tagsStr + "<" + type + " " + attribute + "=\"true\" " + attrs + ">" + content + "</" + type + ">";
          }, '');
        }
      };
    };
  ...
  function _updateTags(options) {
    ...
    return function updateTags(type, tags, headTag) {
      ...
      newTags.forEach(function (tag) {
        return headTag.appendChild(tag);
      });
...
var _vueMeta = __webpack_require__(16);
...
Component.options.__file = "D:\\Dokumenty\\_Freelancing\\___dev_projects\\webSpring-Vue\\src\\components\\component.vue"
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(6).rerender("data-v-99ecdc1c", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(33)("6aed1be7", content, false);
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
